...
public class DestinationAirportMain
{
    ...
    public static void main (String[] args)
    {
        ...
        String rmiRegHostName = "change";                                         // name of the platform where is located the RMI registering service
        ...
        DestinationAirportInterface destAirportStub = null;                          // remote reference to the destination airport object

        try
        { destAirportStub = (DestinationAirportInterface) UnicastRemoteObject.exportObject (destAirport, portNumb);
        }
        catch (RemoteException e)
        ...
        try
        { reg.bind (nameEntryObject, destAirportStub);
        }
        catch (RemoteException e)
