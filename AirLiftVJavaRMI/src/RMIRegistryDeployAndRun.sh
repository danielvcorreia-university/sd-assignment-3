...
sshpass -f password ssh sd107@l040101-ws05.ua.pt 'cd ~/AirLift/dirRMIRegistry ; cp interfaces/*.class ~/Public/classes/interfaces ; cp set_rmiregistry_d.sh ~'
echo "Executing program at the RMIregistry node."
sshpass -f password ssh sd107@l040101-ws05.ua.pt './set_rmiregistry_d.sh sd107 22164'
