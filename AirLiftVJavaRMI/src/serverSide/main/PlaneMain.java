...
/**
 *    Instantiation and registering of a plane object.
 *
...
public class PlaneMain
{
    ...
    public static void main (String[] args)
    {
        ...
        Plane plane = new Plane (reposStub);                 // plane object
        ...
        { GenericIO.writelnString ("The data type PlaneMain was not found (blocking)!");
            e.printStackTrace ();
            System.exit (1);
        }
    ...
    public static void shutdown ()
    {
        ...
        { GenericIO.writelnString ("The data type PlaneMain was not found (waking up)!");
            e.printStackTrace ();
            System.exit (1);
        }
    }
